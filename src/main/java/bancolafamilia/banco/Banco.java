...
public class Banco implements IOpBcoCliente, IOpBcoEmpleado {
    ...
    public void addUser(User user) {
        ...
        if (user instanceof Empleado){ //agregue esto para que se haga la lista de empleados y despues iterar sobre ella en la linea 118
            this.empleados.add((Empleado) user);
        }
    ...
    public void agregarOperacion(Operacion operacion){ //metodo de la interfaz IOpBcoCliente
        operacionesPendientes.add(operacion);
    }

    public void aprobarOperacion(Operacion operacion){ //metodo de la interfaz IOpBcoEmpleado
        operacion.aprobar();
    }
        ...
        if (amount <= 1000000) {
            ...
            if (this.hayOpEnCola(operacionesPendientes)) {
                for (Empleado empleado : empleados) {
                    this.procesarOperacion(empleado); //en este paso el estado de la transferencia cambia
                }
